...
std::vector<Library> imguiLibrary() {
  return {{"imgui", "Dear ImGui", "https://github.com/ocornut/imgui",
           "Dear ImGui: Bloat-free Immediate Mode Graphical User interface for "
...
std::vector<Library> otherLibraries() {
  return {
      {"ImGuiColorTextEdit", "ImGuiColorTextEdit",
       ...
       "Syntax highlighting text editor for ImGui. Demo project: "
       "[https://github.com/BalazsJako/ColorTextEditorDemo](https://github.com/"
      ...
      {"imgui_markdown", "imgui_markdown",
       "https://github.com/juliettef/imgui_markdown",
       "Markdown for Dear ImGui. [Become a "
       "Patron](https://www.patreon.com/enkisoftware)",
       make_string_vec(R"(
                README.md
                License.txt
                imgui_markdown.h
      ...
      {"fplus", "FunctionalPlus", "https://github.com/Dobiasd/FunctionalPlus",
       ...
       "code. [API Browser](http://www.editgym.com/fplus-api-search/) - [Udemy "
       "course](https://www.udemy.com/course/functional-programming-using-cpp/"
       ") - [Browse the "
       "code](https://sourcegraph.com/github.com/Dobiasd/FunctionalPlus/-/tree/"
       "include/fplus). ",
       make_string_vec(R"(
                README.md
                LICENSE
...
std::vector<Library> helloImGuiLibrary() {
  return {
      {"hello_imgui", "Hello ImGui", "https://github.com/pthom/hello_imgui",
       "Hello, Dear ImGui: cross-platform Gui apps for Windows / Mac / Linux / "
       "iOS / Android / Emscripten with the simplicity of a \"Hello World\" "
       "app",
       make_string_vec(R"(
                README.md
                LICENSE
...
std::vector<Library> imguiManualLibrary() {
  return {
      {"imgui_manual", "", "https://github.com/pthom/imgui_manual",
       "Dear ImGui Manual: an interactive manual for ImGui", make_string_vec(R"(
                Readme.md
            )")},
  };
}
