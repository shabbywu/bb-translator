...
ImGuiTreeNodeFlags makeTreeNodeFlags(bool isLeafNode, bool isSelected) {
  ...
  static ImGuiTreeNodeFlags leafFlags = baseTreeFlags |
...
int GuiHeaderTree::guiImpl(int currentEditorLineNumber,
                           const HeaderTree &headerTree, bool isRootNode) {
  ...
  std::string title =
      lineWithTag.tag + "##" + std::to_string(lineWithTag.lineNumber);
