...
HeaderTree *searchParent(HeaderTree *treeRoot, HeaderTree *currentNode, int siblingHeaderLevel)
{
...
void makeHeaderTrees_Impl(std::deque<LineWithTag> &headerLinesStream, HeaderTree *treeRoot,
