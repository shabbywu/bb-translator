...
void LoadFonts() {
  ...
  fontH2 =
      HelloImGui::LoadFontTTF(fontFilename, 15.f + fontSizeStep * 2.f, true);
  fontH1 =
      HelloImGui::LoadFontTTF(fontFilename, 15.f + fontSizeStep * 3.f, true);
}
...
ImGui::MarkdownConfig factorMarkdownConfig() {
  return {LinkCallback,
          ...
          ImageCallback,
          ICON_FA_LINK,
          {{fontH1, true}, {fontH2, true}, {NULL, false}}};
}
